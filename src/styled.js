...
function Admonition (props) {
  return (
    <div className={'admonition admonition-' + props.type}>
      <div className='admonition-heading'>
        <h5>
          <div className='admonition-icon'>
            {returnIcon(props.type, props.iconType)}
          </div>{' '}
          {props.title || props.type}
        </h5>
      </div>
      <div className='admonition-content'>{props.content}</div>
    </div>
  )
}

var StyledAdmonition = styled(Admonition)`
  /**
...
export default StyledAdmonition
